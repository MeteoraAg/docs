...
Stable Swap pools use a **0.01%** trade fee with **0%** Protocol Fee and **100%** LP Fee. See [DAMM v1 Fee and APY Calculation](/overview/products/damm-v1/damm-v1-fee-and-apy-calculation) for how protocol fees apply across pool types.
