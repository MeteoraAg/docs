...
llmsDescription: "Explains how DAMM v1 fee and APY calculation works, covering swap fees, protocol fees, LP fee value, virtual price growth, base APY, 365-day fee over TVL, farm APR, Dynamic Vault yield, and caveats when comparing displayed returns."
---
