...
<div className="relative min-h-screen text-[#181D27] dark:text-[#F9F9FB]">
  ...
  <div className="flex flex-col items-center justify-center pt-[120px] pb-[93px]">
    ...
    <div className="max-w-xl mx-auto pt-[20px]">
      <CardGroup cols={1}>
        <Card title="Want to integrate with Meteora?" icon="terminal">
          ...
          <Columns cols={1}>
            <Card title="Integrate with Meteora DBC" href="/developer-guide/trading-terminals/integrate-with-dbc" icon="wrench" horizontal />
            <Card title="Integrate with Meteora DAMM v2" href="/developer-guide/trading-terminals/integrate-with-damm-v2" icon="hammer" horizontal />
          </Columns>
        </Card>
      </CardGroup>
    </div>
