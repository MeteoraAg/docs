...
<div className="relative min-h-screen text-[#181D27] dark:text-[#F9F9FB]">
  ...
  <div className="max-w-6xl mx-auto pt-[110px] md:pt-[140px] pb-[60px] md:pb-[80px] px-4">
  ...
  <div className="max-w-6xl mx-auto px-4 py-[60px] md:py-[80px]">
    <div className="w-full h-px bg-gradient-to-r from-transparent via-gray-300 dark:via-gray-600 to-transparent"></div>
  </div>

  <div className="max-w-6xl mx-auto pt-[40px] md:pt-[60px] pb-[60px] md:pb-[80px] px-4">
  ...
  <div className="max-w-6xl mx-auto pt-[40px] md:pt-[60px] pb-[120px] md:pb-[183px] px-4">
