...
<div className="relative min-h-screen text-[#181D27] dark:text-[#F9F9FB]">
  ...
  <div className="flex flex-col items-center justify-center pt-[80px] md:pt-[120px] pb-[60px] md:pb-[93px] relative px-4">
    {/* Floating elements positioned relative to hero content - hidden on mobile */}
    ...
    <div className="hidden lg:block absolute right-[22%] top-[30%] w-20 h-20 rounded-xl overflow-hidden">
      <img 
    ...
    <div className="text-center max-w-4xl mx-auto pt-24 sm:pt-0">
      <div className="text-center justify-start bg-gradient-to-r from-[#F54B00] to-[#6E45FF] bg-clip-text text-transparent text-sm sm:text-base font-medium font-['Inter'] leading-normal">Welcome to Meteora Documentation!</div>
      <div className="text-center justify-start text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-semibold font-['Inter'] leading-tight sm:leading-[60px] md:leading-[80px] lg:leading-[96px] mt-2">Build with Meteora</div>
      <div className="max-w-[660px] mx-auto text-center justify-start text-[#535862] dark:text-[#A6A09E] text-base sm:text-lg font-normal font-['Inter'] leading-6 sm:leading-7 mt-4">Learn how to launch liquidity pools, crafting bonding curves, and providing liquidity on the most secure and dynamic liquidity layer in all of DeFi.</div>
  ...
  <div className="max-w-6xl mx-auto pt-[120px] md:pt-[175px] px-4">
    <div className="flex justify-center text-2xl sm:text-3xl md:text-4xl font-bold font-['Inter'] leading-tight md:leading-10 pb-[10px]">Product Suite</div>
    <div className="flex justify-center text-[#535862] dark:text-[#A6A09E] text-base sm:text-lg font-normal font-['Inter'] leading-6 sm:leading-7 pb-[40px] sm:pb-[56px] text-center">Develop with Meteora's comprehensive tech stack</div>

    <CardGroup cols={1} lg={2}>
  ...
  <div className="max-w-6xl mx-auto pt-[80px] md:pt-[120px] px-4">
    <div className="flex justify-center text-2xl sm:text-3xl md:text-4xl font-bold font-['Inter'] leading-tight md:leading-10 pb-[10px]">Anti Sniper Suite</div>
    <div className="flex justify-center text-[#535862] dark:text-[#A6A09E] text-base sm:text-lg font-normal font-['Inter'] leading-6 sm:leading-7 pb-[40px] sm:pb-[56px] text-center">Sniping tokens is a feature. Choose to turn it on or off with Meteora's Anti Sniper Suite.</div>

    <CardGroup cols={1} md={3}>
  ...
  <div className="max-w-6xl mx-auto pt-[80px] md:pt-[120px] px-4">
    <div className="flex justify-center text-2xl sm:text-3xl md:text-4xl font-bold font-['Inter'] leading-tight md:leading-10 pb-[10px]">Trading Terminals</div>
    <div className="flex justify-center text-[#535862] dark:text-[#A6A09E] text-base sm:text-lg font-normal font-['Inter'] leading-6 sm:leading-7 pb-[40px] sm:pb-[56px] text-center">All tokens launched via Meteora's pools programs are immediately tradeable across all major trading terminals.</div>
  ...
  <div className="max-w-6xl mx-auto pt-[80px] md:pt-[120px] pb-[120px] md:pb-[183px] px-4">
    <div className="flex justify-center text-2xl sm:text-3xl md:text-4xl font-bold font-['Inter'] leading-tight md:leading-10 pb-[10px]">Join the LP Army</div>
    <div className="flex justify-center text-[#535862] dark:text-[#A6A09E] text-base sm:text-lg font-normal font-['Inter'] leading-6 sm:leading-7 pb-[40px] sm:pb-[56px] text-center">The LP Army is a movement and community of the best liquidity providers in crypto.</div>

    <CardGroup cols={1} md={2}>
