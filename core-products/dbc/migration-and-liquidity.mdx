...
llmsDescription: "Explains DBC migration and liquidity behavior, including curve completion, transfer-hook revocation on completion, migration progress states, deprecated DAMM v1 migration for new configs, DAMM v2 migration, token-badge quote mint graduation through CreatePoolWithoutMintValidation, locked vesting step, migrated liquidity ownership, DAMM v1 LP token claims for existing pools, DAMM v2 position NFT creation and ownership transfer, unlocked liquidity, permanently locked liquidity, vesting liquidity, 10 percent day-one locked liquidity requirement, two-year vesting duration cap, leftover handling, protocol liquidity migration fee, and mainnet migration keepers that graduate matching quote-mint thresholds, Stock Token quote pairs at least 750 USD equivalent, and Jupiter Verified quote tokens with Organic Score greater than 50 and notional value greater than 750 USD."
---
