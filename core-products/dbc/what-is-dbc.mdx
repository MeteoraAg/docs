...
description: "Learn how Meteora's Dynamic Bonding Curve helps teams launch tokens with configurable price discovery, launch fees, trader controls, DAMM v2 migration, surplus handling, Token 2022 support, quote-mint token badges, and transfer-hook pools."
llmsDescription: "Overview of Meteora Dynamic Bonding Curve, explaining DBC as a permissionless token launch product with a virtual pool, configurable universal curve segments, quote threshold migration, DAMM v2 graduation, deprecated DAMM v1 and rate limiter options for new configs, launch fees, trader experience, creator and partner controls, fixed and dynamic supply, migration liquidity, leftover, surplus, Token 2022 support, quote-mint token badges, and Token 2022 transfer-hook pools."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Automatic Graduation" icon="arrow-right" iconType="solid">
    Once the quote reserve reaches the migration threshold, liquidity can move into a DAMM v2 pool. Existing DAMM v1 pools can still graduate.
  </Card>
  <Card title="Launch-Ready Fees" icon="shield" iconType="solid">
    Use fixed fees, time schedulers, and optional dynamic fees to shape early trading behavior. Rate limiter mode is deprecated for new configs.
  </Card>
  ...
  <Card title="Token 2022 Support" icon="certificate" iconType="solid">
    DBC can launch SPL tokens, Token 2022 tokens, and Token 2022 transfer-hook pools, including Token 2022 quote mints that need a token badge.
  </Card>
</CardGroup>
...
| Migrate to DAMM | The accumulated quote reserve and configured base amount seed the DAMM v2 pool. Existing DAMM v1 pools still use the DAMM v1 path. |
...
<CardGroup cols={2}>
  ...
  <Card title="DBC Token 2022 Support" href="/core-products/dbc/token-2022-support" icon="certificate">
    Understand how DBC supports Token 2022 base tokens, quote mints, and quote-mint token badges.
  </Card>
