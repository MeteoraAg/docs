...
<CardGroup cols={2}>
  ...
  <Card title="DBC Trader Experience" href="/core-products/dbc/trader-experience" icon="users">
  ...
  <Card title="DBC Surplus" href="/core-products/dbc/surplus" icon="coins">
    Learn what happens when a pool collects more quote tokens than the migration threshold.
  </Card>
  <Card title="DBC Leftover" href="/core-products/dbc/leftover" icon="box-open">
