...
description: "Learn how DAMM v2 distributes built-in liquidity mining rewards directly to LP positions."
llmsDescription: "Documentation for DAMM v2 liquidity mining, covering built-in reward slots, up to two reward tokens per pool, reward duration limits, reward funder permissions, reward rate fixed-point accounting, reward-per-liquidity accounting, position reward accrual, claiming rewards, locked liquidity earning rewards, empty-liquidity carry-forward behavior, Token 2022 reward support, and use cases."
---
...
| Token 2022 reward tokens | Supported with the same permissionless extensions and token badge rules as pool mints |
