...
description: A unified command center for DLMM liquidity providers — featuring professional-grade TradingView charts, real-time position tracking, and streamlined position management.
---
...
<Frame>
  <img src="/images/user-guide/dynamic-terminal-overview.webp" alt="Meteora Dynamic Terminal" />
</Frame>
...
<Frame>
  <video autoPlay muted loop playsInline preload="none" src="/images/user-guide/left-panel.mp4" />
</Frame>
...
<Frame>
  <video autoPlay muted loop playsInline preload="none" src="/images/user-guide/concentrated-liquidity-position.mp4" />
</Frame>
...
<Frame>
  <video autoPlay muted loop playsInline preload="none" src="/images/user-guide/position-list.mp4" />
</Frame>
...
<Note>You do not receive an LP token or NFT for your position. Your position is a unique DLMM program account and cannot be transferred to another wallet.</Note>
...
<Frame>
  <img src="/images/user-guide/quick-action.gif" alt="Quick Actions" loading="lazy" />
</Frame>
...
<Frame>
  <video autoPlay muted loop playsInline preload="none" src="/images/user-guide/manage-position.mp4" />
</Frame>
...
<Frame>
  <video autoPlay muted loop playsInline preload="none" src="/images/user-guide/customize-layout.mp4" />
</Frame>
