...
description: "Learn how DLMM Liquidity Mining incentivizes active liquidity, how reward-enabled pools distribute rewards, and how LPs claim eligible rewards."
llmsDescription: "Explains DLMM Liquidity Mining as the token reward mechanism for active DLMM liquidity, matching the lb_clmm program's LiquidityMining function type and is_support_liquidity_mining behavior. Covers liquidity-mining pool mode, why liquidity mining matters, who earns rewards, active-bin and crossed-bin reward updates, the 15-bin reward split limit, pro-rata distribution by liquidity share, fixed reward emission over time, manual claiming, non-compounding rewards, empty-liquidity accounting, and product takeaways for LPs, token teams, and traders."
---
