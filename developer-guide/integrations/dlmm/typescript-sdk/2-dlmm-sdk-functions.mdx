...
- [createCustomizablePermissionlessLbPair](#createCustomizablePermissionlessLbPair)
- [createCustomizablePermissionlessLbPair2](#createCustomizablePermissionlessLbPair2)
- [createLbPair](#createLbPair)
- [createLbPair2](#createLbPair2)
...
- [claimAllRewardsByPosition](#claimAllRewardsByPosition)
- [closePosition](#closePosition)
- [closePositionIfEmpty](#closePositionIfEmpty)
- [quoteCreatePosition](#quoteCreatePosition)
- [createEmptyPosition](#createEmptyPosition)
- [seedLiquidity](#seedLiquidity)
- [seedLiquiditySingleBin](#seedLiquiditySingleBin)
- [initializeBinArrays](#initializeBinArrays)
...
### State Functions
- [getLbPairs](#getLbPairs)
- [getCustomizablePermissionlessLbPairIfExists](#getCustomizablePermissionlessLbPairIfExists)
...
- [getLbPairLockInfo](#getLbPairLockInfo)
- [canSyncWithMarketPrice](#canSyncWithMarketPrice)
...
- [calculateFeeInfo](#calculateFeeInfo)
...
#### Notes
- If Alpha Vault is enabled, the program will deterministically whitelist the alpha vault to swap before the pool start trading. Check: https://github.com/MeteoraAg/alpha-vault-sdk initialize{Prorata|Fcfs}Vault method to create the alpha vault.
