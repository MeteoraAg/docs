...
<CardGroup cols={2}>
  <Card title="Mainnet (Latest)" icon="globe" href="https://damm-api.meteora.ag/swagger-ui/">
    Access the latest Swagger UI documentation for DAMM v1 APIs
  </Card>
  <Card title="Mainnet (Legacy)" icon="box-archive" href="https://amm-v2.meteora.ag/swagger-ui/">
    Legacy Swagger UI documentation (mainnet)
  </Card>
  <Card title="Devnet (Latest)" icon="code" href="https://damm-api.devnet.meteora.ag/swagger-ui/">
    Swagger UI for development and testing environment
  </Card>
  <Card title="Devnet (Legacy)" icon="file-zipper" href="https://damm-api.devnet.meteora.ag/swagger-ui/">
