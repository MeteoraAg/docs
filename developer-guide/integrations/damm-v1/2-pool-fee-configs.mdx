...
<CardGroup cols={1}>
  <Card title="Mainnet Pool Config List API" href="https://amm-v2.meteora.ag/swagger-ui/#/pools/get_all_pool_configs" icon="link" iconType="solid">
    Access the complete list of pool configurations available on Mainnet for DAMM v1 pools.
  </Card>
  <Card title="Devnet Pool Config List API" href="https://devnet-amm-v2.meteora.ag/pool-configs" icon="link" iconType="solid">
    Access the complete list of pool configurations available on Devnet for testing and development.
  </Card>
  <Card title="Fee Curve Configuration API" href="https://amm-v2.meteora.ag/swagger-ui/#/fee_config/get_config_associated_fee_configs" icon="link" iconType="solid">
...
<CardGroup cols={1}>
  <Card title="Fee Curve Configuration API" href="https://amm-v2.meteora.ag/swagger-ui/#/fee_config/get_config_associated_fee_configs" icon="link" iconType="solid">
    Access the associated fee curve configurations for each existing pool config.
  </Card>
</CardGroup>
...
<Note>If your preferred configs are not available in the pre-defined config lists above, please contact the Meteora team. You will need your own unique config key specific to your integration.</Note>
