...
<Frame>
  <img src="/images/developer-guide/metsumi-2.png" />
</Frame>
...
<Steps>
  ...
  *If you want to create a balanced pool, you can run the following command.*
  ...
  <Frame>
   <img src="/images/developer-guide/damm-v2-create-balanced-pool.png" />
  </Frame>
  ...
  *If you want to create a one-sided pool, you can run the following command.*
  ...
  <Frame>
   <img src="/images/developer-guide/damm-v2-create-one-sided-pool.png" />
  </Frame>
