...
In this guide, we will walk you through the steps to create a DAMM v1 launch pool on Meteora. Whether you’re a seasoned developer or just starting out, this guide has got you covered to deploy liquidity and launch your project on Meteora.
...
<Steps>
  ...
  This will create your pool with liqudity deposited from your `keypair.json` and print the pool address and other relevant information to the console.
  </Step>
</Steps>
