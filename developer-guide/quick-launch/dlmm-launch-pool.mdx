...
In this guide, we will walk you through the steps to create a DLMM launch pool on Meteora. Whether you’re a seasoned developer or just starting out, this guide has got you covered to deploy liquidity and launch your project on Meteora.
...
<Steps>
  ...
  <Frame caption="This example includes creating of baseMint token before creating the DLMM launch pool.">
   <img src="/images/developer-guide/quick-launch/dlmm-create-pool.png" />
  </Frame>
  ...
  *If you want to seed your pool with liquidity using the LFG model, you can run the following command.*
  ...
  <Frame>
   <img src="/images/developer-guide/quick-launch/dlmm-seed-liquidity-lfg.png" />
  </Frame>
  ...
  *If you want to seed your pool with liquidity in a single bin, you can run the following command.*
  ...
  <Frame>
   <img src="/images/developer-guide/quick-launch/dlmm-seed-liquidity-single-bin.png" />
  </Frame>
  </Step>
</Steps>
