      ...
      */
      "dbcConfig": {
        ...
        */
        ...
        /* Liquidity Vesting Info (Only for DAMM v2 migration - migrationOption: 1)
        * These parameters configure vesting schedules for partner/creator liquidity in the graduated DAMM v2 pool.
        * Set all values to 0 if you don't want liquidity vesting.
        */
        ...
        "migratedPoolBaseFeeMode": 0, // 0 - FeeTimeSchedulerLinear (default) | 1 - FeeTimeSchedulerExponential | 3 - FeeMarketCapSchedulerLinear | 4 - FeeMarketCapSchedulerExponential (only for DAMM v2)
