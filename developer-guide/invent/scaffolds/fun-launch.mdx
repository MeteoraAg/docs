  ...
  <Step title="Setup Environment Variables">
    ...
    <Tip>
        **Getting Pool Config Key**
        You can get your pool config key from [Meteora Launch](https://launch.meteora.ag) or execute an action with Metsumi to create a DBC config in [Meteora Invent](/developer-guide/invent/metsumi-actions#dbc).
    </Tip>
  </Step>
