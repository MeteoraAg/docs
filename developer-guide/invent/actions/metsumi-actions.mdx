...
<Frame>
  <img src="/images/metsumi/metsumi-banner-1.webp" />
</Frame>
...
Powered by [Meteora Invent](https://github.com/MeteoraAg/meteora-invent), **Metsumi** can help you to:
...
<CardGroup>
  ...
  <Card title="Seed Liquidity" icon="seedling" iconType="solid" href="https://github.com/MeteoraAg/meteora-invent?tab=readme-ov-file#dlmm-scripts">
    Seed Liquidity with your preferred curve
  </Card>
  <Card title="Seed Liquidity Single Bin" icon="trash" iconType="solid" href="https://github.com/MeteoraAg/meteora-invent?tab=readme-ov-file#dlmm-scripts">
    Seed Liquidity in a single bin
  </Card>
  <Card title="Set Pool Status" icon="signal-bars" iconType="solid" href="https://github.com/MeteoraAg/meteora-invent?tab=readme-ov-file#dlmm-scripts">
...
<CardGroup>
  ...
  <Card title="Lock Liquidity" icon="lock" iconType="solid" href="https://github.com/MeteoraAg/meteora-invent?tab=readme-ov-file#damm-v1-scripts">
    Lock liquidity for a DAMM v1 pool
  </Card>
  <Card title="Create a Stake2Earn Farm" icon="farm" iconType="solid" href="https://github.com/MeteoraAg/meteora-invent?tab=readme-ov-file#damm-v1-scripts">
    Create a Stake2Earn Farm for a DAMM v1 pool
  </Card>
  <Card title="Lock Liquidity for Stake2Earn Farm Pool" icon="lock-a" iconType="solid" href="https://github.com/MeteoraAg/meteora-invent?tab=readme-ov-file#damm-v1-scripts">
...
<CardGroup>
  ...
  <Card title="Create a DBC Config" icon="gear" iconType="solid" href="https://github.com/MeteoraAg/meteora-invent?tab=readme-ov-file#dbc-scripts">
    Create a Dynamic Bonding Curve config containing the settings for pre-graduation and post-graduation pools
  </Card>
  <Card title="Claim Trading Fees" icon="money-bill" iconType="solid" href="https://github.com/MeteoraAg/meteora-invent?tab=readme-ov-file#dbc-scripts">
    Claim partner and/or creator trading fees for a DBC pool
  </Card>
  <Card title="Migrate to DAMM v1" icon="house" iconType="solid" href="https://github.com/MeteoraAg/meteora-invent?tab=readme-ov-file#dbc-scripts">
    Migrate your DBC pool to a DAMM v1 pool
  </Card>
  <Card title="Migrate to DAMM v2" icon="house-heart" iconType="solid" href="https://github.com/MeteoraAg/meteora-invent?tab=readme-ov-file#dbc-scripts">
    Migrate your DBC pool to a DAMM v2 pool
  </Card>
  <Card title="Swap (Buy/Sell)" icon="arrows-split-up-and-left" iconType="solid" href="https://github.com/MeteoraAg/meteora-invent?tab=readme-ov-file#dbc-scripts">
