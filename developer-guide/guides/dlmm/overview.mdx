...
Before getting started building on DLMM, you should read the following resources to get a better understanding of how Meteora's DLMM works:
...
At Meteora, we’ve developed a `Node.js <> Typescript SDK` and a `Rust CPI Examples` to make deploying and managing your DLMM liquidity pool easier. The following sections includes information on installing and using these SDKs. It also covers where to find the latest documentation, and how to contribute to these SDKs.
