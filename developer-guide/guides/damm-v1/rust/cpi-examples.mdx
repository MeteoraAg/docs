...
<CardGroup cols={1}>
  ...
  <Card title="CPI Example for DAMM v1 Initialize Stake2Earn Vault" href="https://github.com/MeteoraAg/cpi-examples/blob/main/programs/cpi-example/src/instructions/m3m3_cpi/initialize_vault.rs">
