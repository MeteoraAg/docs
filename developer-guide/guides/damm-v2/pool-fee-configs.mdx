...
<AccordionGroup>
  <Accordion title="View all public config key addresses (JSON)">
    ```json
    [
        {
            "index": 0,
...
<Note>If you're a launchpad or integrator that's keen to create your own unique custom pool config key with custom `pool_fees`, please reach out to the team.</Note>