...
<Note>
- <code>initialize_pool</code> requires a <b>static config key</b> to create the pool. Each DAMM v2 pool is a PDA of <code>tokenAMint</code> + <code>tokenBMint</code> + <code>staticConfig</code>.
<br />
- <code>initialize_pool_with_dynamic_config</code> requires a <b>dynamic config key</b> to create the pool. Each DAMM v2 pool is a PDA of <code>tokenAMint</code> + <code>tokenBMint</code> + <code>dynamicConfig</code>.
<br />
- <code>initialize_customizable_pool</code> does <b>not</b> require any config key and is also known as the DAMM v2 <b>Launch Pool</b>. Each DAMM v2 launch pool is a PDA of <code>tokenAMint</code> + <code>tokenBMint</code>.
</Note>
