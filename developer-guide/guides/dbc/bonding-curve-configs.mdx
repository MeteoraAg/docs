...
- `partnerLiquidityVestingInfo` - Optional vesting configuration for the partner's LP position
- `creatorLiquidityVestingInfo` - Optional vesting configuration for the creator's LP position
