...
Build your own fully customizable bonding curve with DBC. DBC allows you to configure everything from pre-graduation to post-graduation, the shape of your bonding curve, and the trading fees.
