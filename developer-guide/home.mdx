...
<CardGroup cols={1}>
  ...
  <Card title="Stake2Earn" icon="steak" iconType="solid" href="/developer-guide/integrations/stake2earn/1-introduction">
    ...
    <Card title="Meteora Lock" icon="lock" iconType="solid" href="/developer-guide/integrations/meteora-lock/1-introduction">
    ...
    <Card title="Dynamic Fee Sharing" icon="money-bill-wave" iconType="solid" href="/developer-guide/integrations/dynamic-fee-sharing/1-introduction">
  ...
  <Card title="Zap" icon="bolt-lightning" iconType="solid" href="/developer-guide/integrations/zap/1-introduction">
