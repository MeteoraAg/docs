...
Meteora's Dynamic Terminal features a fully integrated [TradingView](https://www.tradingview.com) price chart — the same charting platform trusted by millions of professional traders worldwide. No need to switch tabs or use a separate tool. Everything you need to analyze price and manage your liquidity position is in one place.

<Frame>
  <img src="/images/user-guide/dynamic-terminal-tradingview-chart.webp" alt="TradingView Chart in Meteora Dynamic Terminal" />
</Frame>
...
<Frame>
  <img src="/images/user-guide/dynamic-terminal-tradingview-indicators.webp" alt="TradingView Indicators" />
</Frame>
