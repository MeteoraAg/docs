...
<AccordionGroup>
  ...
  <Accordion title="Will there be gas fees to claim my allocation?">
    Solana fees are typically a few cents or less; keep a small SOL balance for network fees. To claim the NFT will require ~0.02 SOL.
  </Accordion>
...
<AccordionGroup>
  <Accordion title="Where can I trade after TGE?">
    Initial liquidity will be on the Meteora DAMM v2 pool. Centralized exchange listings will be announced separately.
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title='A site says I must "reconnect" or "re-sync" to claim. Is that legit?'>
    Treat as suspicious unless linked in our announcement.
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="I think my points/allocation are wrong, can you recalculate?">
    Allocations are final. If you believe there's a technical error, open a support ticket with wallet + tx links. (See [support policy](#support-policy) below.)
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="When and where can we opt in for a Liquidity Distributor NFT?">
    On the official TGE site. {/* TODO: Add TGE site link */} The date of claim will be announced on our official socials.
  </Accordion>
  ...
  <Accordion title="Is registration for Liquidity Distributor NFT capacity limited? Is there a cap?">
    Yes. The total supply is capped at 10% of total MET supply.
  </Accordion>

  <Accordion title="How long is the Liquidity Distributor NFT registration period?">
    Until Sunday, 19 October, 23:59 UTC+8
  </Accordion>

  <Accordion title="How long is the MET allocation Claim Window?">
    ~6 months. End of April, 2026
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="My claim failed / I received fewer tokens than expected">
    1. Check that you're on the correct wallet and network (Solana)
    2. Ensure you have SOL for fees
    3. Refresh and retry; if it persists, open a ticket with your wallet + tx link
    4. For swaps, check slippage, pool TVL, and whether a token has transfer fees (some tokens do enable them)
  </Accordion>
  ...
  <Accordion title="Why does claiming my allocation cost so much?">
...
<AccordionGroup>
  ...
  <Accordion title="What is the DAMMv2 launch pool range?">
    The pool will start at \$500m FDV and will spread liquidity to \$5b FDV.
  </Accordion>
</AccordionGroup>
...
<Warning>
  ...
  - Participation may be restricted where prohibited by law.
  - All timelines are estimates and can change due to technical or regulatory factors.
</Warning>
