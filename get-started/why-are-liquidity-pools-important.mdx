...
llmsDescription: "Explains why liquidity pools and liquidity providers are foundational to DeFi on Solana. Covers how new tokens, DApps, DeFi services, liquidations, wrapped assets, and cross-chain liquidity depend on deep liquidity; why trades rely on liquidity pools; the many ways LPs can provide liquidity; the range of LP participants from market makers to creators and launchpads; and why liquidity pools and launchpads matter for future token creation."
---

<video autoPlay muted loop playsInline preload="none" src="/get-started/assets/man-seeing-a-spaceship.mp4" />
