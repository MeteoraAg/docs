...
description: "Composable Liquidity Layer for Liquidity Providers, Launchpads and Token Launches on Solana."
llmsDescription: "Welcome page for Meteora Documentation. Introduces Meteora as Solana DEX (Decentalized Exchange) and provides quick navigation to Core Products (DLMM, DAMM v2, DBC), Helper Products (Presale Vault, Alpha Vault, Dynamic Fee Sharing, Zap), Legacy Products (DAMM v1, Dynamic Vault, Stake2Earn), Developer Resources (Developer Guides and APIs), AI Resources (CLI, Skills, MCP, llms.txt), How to Create Launch Pools, Community Links, Socials (Blog and X)."
---
...
<CardGroup cols={3}>
  <Card title="Liquidity Providers" icon="users" iconType="solid">
    Earn fees and rewards across Solana's largest, most active LP community.
  </Card>
  <Card title="Launchpads" icon="rocket" iconType="solid">
    Power day-one liquidity for every project you launch with battle-tested pools.
  </Card>
  <Card title="Launches" icon="star" iconType="solid">
