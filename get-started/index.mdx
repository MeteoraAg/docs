...
llmsDescription: "Welcome page for Meteora Documentation. Introduces Meteora as dynamic liquidity infrastructure for Solana token launches, liquidity providers, launchpads, and builders. Provides navigation to Core Products such as DLMM, DAMM v2, and Dynamic Bonding Curve; Helper Products such as Presale Vault, Alpha Vault, Dynamic Fee Sharing, and Zap; Legacy Products such as DAMM v1, Dynamic Vault, and Stake2Earn; Developer Guides; AI agent resources; Meteora Invent launch-pool workflows; and community links."
---

<video autoPlay muted loop playsInline preload="none" src="/get-started/assets/meteor.mp4" />
