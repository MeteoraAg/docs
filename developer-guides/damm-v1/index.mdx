...
<CardGroup cols={2}>
  <Card title="DAMM v1 Program" icon="code" href="https://github.com/MeteoraAg/meteora-dynamic-amm/tree/main/programs/amm">
    Anchor program source for the deployed dynamic AMM.
  </Card>
