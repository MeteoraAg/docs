...
description: "Set up the Meteora DAMM v1 Farming TypeScript SDK and start building farm integrations."
llmsDescription: "Getting started guide for Meteora DAMM v1 Farming SDK development. Covers the @meteora-ag/farming-sdk package, reward-pool repository, npm, pnpm, and yarn installation commands, required @meteora-ag/dynamic-amm-sdk and @solana/web3.js dependencies, Farming SDK initialization, and development resources such as Solana RPC endpoints and faucets."
---
...
<Note>You can also get the pool with farm address from the DAMM v1 Pool With Farms [endpoint](/api-reference/damm-v1/pools/pools-with-farms).</Note>
