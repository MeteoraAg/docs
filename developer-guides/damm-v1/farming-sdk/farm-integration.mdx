...
sidebarTitle: "Farm Integration"
description: "Integrate DAMM v1 farm staking, claiming, unstaking, and balance checks with the Meteora Farming TypeScript SDK."
llmsDescription: "Code examples for integrating DAMM v1 pools with Meteora farms using @meteora-ag/dynamic-amm-sdk and @meteora-ag/farming-sdk. Covers permissioned DAMM v1 farm context, creating AMM and farm clients, reading LP balances, staking LP tokens, claiming rewards, unstaking, and checking a user's staked balance with Solana web3.js."
---
