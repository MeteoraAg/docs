...
<CardGroup cols={2}>
  <Card title="DAMM v1 Typescript SDK" icon="node-js" iconType="solid" href="https://github.com/MeteoraAg/damm-v1-sdk">
    Meteora DAMM v1 Typescript SDK
  </Card>
  <Card title="DAMM v1 NPM Package" icon="npm" iconType="solid" href="https://www.npmjs.com/package/@meteora-ag/dynamic-amm-sdk">
...
<Note>Only for DAMM v1 SDK.</Note>
