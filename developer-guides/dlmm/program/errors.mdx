...
sidebarTitle: "Errors"
description: "Reference lb_clmm Anchor custom errors, including error codes, enum names, messages, and troubleshooting notes for DLMM integrations."
llmsDescription: "Reference for DLMM lb_clmm program errors sourced from the onchain program LBError enum and generated IDL. Covers Anchor custom error code decoding, common categories for slippage, bin arrays, positions, rewards, Token-2022 remaining accounts, limit orders, zap, CPI, and the complete code/name/message table from 6000 through 6110 with explanations of why each error occurs."
---
