...
sidebarTitle: "Errors"
description: "Understand DLMM lb_clmm error codes, messages, instruction mappings, and common causes for integration debugging."
llmsDescription: "Explains the DLMM program error reference based on LBError in MeteoraAg/DLMM. Covers Anchor error codes 6000-6110, hex decoding, instruction-to-error mappings, IDL-only variants, message text, common causes, and how builders can use errors to debug swaps, liquidity, positions, rewards, and limit order transactions."
---
