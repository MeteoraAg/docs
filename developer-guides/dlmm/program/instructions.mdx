...
description: "Explore DLMM lb_clmm instructions for pool creation, swaps, liquidity, positions, rewards, operators, and limit orders."
llmsDescription: "Explains the DLMM program instruction surface for lb_clmm. Covers pool initialization, liquidity and position instructions, swap and swap2 flows, bin array and bitmap setup, reward and fee instructions, operator controls, rebalance flows, limit order instructions such as place_limit_order, and when to use the TypeScript SDK or CPI guide to build complete account lists."
---
