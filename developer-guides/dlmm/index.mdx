...
<CardGroup cols={2}>
  <Card title="What's DLMM?" icon="code" iconType="solid" href="/core-products/dlmm/what-is-dlmm">
  ...
  <Card title="Token 2022 Extensions" icon="puzzle" iconType="solid" href="/core-products/dlmm/token-2022-extensions">
...
|---|---|
| `LiquidityMining` (0) | Pool supports liquidity mining rewards via `initialize_reward`. |

<Warning>The `initialize_reward` instruction only works on pools with `function_type = LiquidityMining`. Pools created without this function type cannot have liquidity mining rewards added later.</Warning>
