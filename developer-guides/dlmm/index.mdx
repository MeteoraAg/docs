...
description: "Entry point for DLMM integrations: lb_clmm program, TypeScript SDK, Rust commons/CPI, Data API, and changelog."
llmsDescription: "DLMM developer guide overview. Routes to program architecture/accounts/instructions/errors, @meteora-ag/dlmm, rust-integration (Library and CPI), Data API, and Changelogs. Lists the lb_clmm program ID and MeteoraAg/dlmm-sdk repo paths."
---
