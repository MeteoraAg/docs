...
description: "Start building on Meteora DLMM with the onchain lb_clmm program."
llmsDescription: "Developer entry point for building on Meteora DLMM. Explains when to use the TypeScript SDK, lb_clmm IDL, Rust CPI integration guidance, DLMM Data API, repository scripts, commons, CLI, changelog, and product documentation links. Includes program IDs, public-source boundaries, recommended build path, and the public dlmm-sdk repository map."
---
...
<CardGroup cols={2}>
  ...
  >
    Call DLMM instructions through Cross Program Invocation.
  </Card>
</CardGroup>
<CardGroup cols={1}>
  <Card
