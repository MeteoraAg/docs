---
title: "DLMM Changelog"
sidebarTitle: "Changelog"
description: "Track DLMM release notes, breaking changes, and upgrade guidance for lb_clmm, SDKs, commons, and CLI tooling."
llmsDescription: "Explains the DLMM integration changelog for builders maintaining Meteora DLMM integrations. Covers versioned release entries, breaking-change callouts, migration notes, upgrade steps, lb_clmm program changes, @meteora-ag/dlmm TypeScript SDK changes, Rust commons updates, CLI updates, and compatibility considerations."
rss: true
---
