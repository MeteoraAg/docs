...
description: "DLMM release notes for lb_clmm, the TypeScript SDK, commons, and CLI."
llmsDescription: "DLMM integration changelog. Versioned release entries with breaking-change callouts and upgrade steps for program, @meteora-ag/dlmm, commons, and CLI."
rss: true
---
