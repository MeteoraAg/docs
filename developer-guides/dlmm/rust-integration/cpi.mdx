...
sidebarTitle: "CPI"
description: "Learn how to call DLMM lb_clmm from Rust programs with generated bindings, event CPI accounts, remaining accounts, and validation."
llmsDescription: "Explains DLMM Rust CPI integration for programs that call lb_clmm. Covers program ID, generated bindings, CPI instruction scope, event CPI accounts, remaining account ordering, swap2 CPI shape, Token 2022 transfer hooks, optional accounts, off-chain account planning, common CPI failures, best practices, devnet validation, and when to prefer SDK transaction construction over direct CPI."
---
