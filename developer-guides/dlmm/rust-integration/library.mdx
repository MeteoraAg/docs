...
| --- | --- |
| `commons/src/lib.rs` | Public exports and generated `dlmm` module. |
| `commons/src/quote.rs` | Swap quote implementation and bin-array route discovery. |
| `commons/src/token_2022.rs` | Token-2022 transfer fee and transfer-hook helpers. |
| `commons/src/extensions` | Account extension traits and parsed position helpers. |
| `commons/tests/integration` | End-to-end examples using generated account metas and instruction args. |
| [DLMM TypeScript SDK Reference](/developer-guides/dlmm/typescript-sdk/reference) | TypeScript SDK behavior to compare against Rust transactions. |
| [DLMM Rust Integration CPI](/developer-guides/dlmm/rust-integration/cpi) | On-chain CPI guidance and account-order debugging workflow. |
