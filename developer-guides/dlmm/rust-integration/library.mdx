...
description: "Learn how to use the DLMM Rust library for installation, account decoding, PDA helpers, bin arrays, swap quotes, and tests."
llmsDescription: "Explains the DLMM Rust integration library in the MeteoraAg/dlmm-sdk commons crate. Covers installation, provided modules, program ID, account decoding, PDA helpers, bin arrays, swap quote math, building swap instructions, Token 2022 remaining-account handling, position and limit order reads, program-test helpers, integration testing patterns, best practices, and why the library is intended for off-chain clients rather than CPI execution."
---
