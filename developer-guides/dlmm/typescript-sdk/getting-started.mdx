...
description: "Install @meteora-ag/dlmm, connect to a pool, and run a swap quote."
llmsDescription: "First steps with @meteora-ag/dlmm: install, DLMM.create, cluster config, pool lookup via Data API, getBinArrayForSwap, and swapQuote."
---
