...
description: "Understand @meteora-ag/dlmm exports, client methods, pool creation, positions, liquidity, swaps, fees, rewards, and helpers."
llmsDescription: "Explains the DLMM TypeScript SDK reference based on the public ts-client source. Covers dependencies, program IDs, core types, enums, constants, DLMM.create, static discovery methods, pool creation methods, instance state, pool reads, price helpers, positions, liquidity, swaps, fees, rewards, limit orders, rebalancing, seed liquidity, bin arrays, pool controls, Token 2022 support, helper exports, oracle helpers, limit order wrappers, error handling, and integration notes."
---
