...
<CardGroup cols={1}>
  <Card title="What's Dynamic Fee Sharing?" icon="question" iconType="solid" href="/helper-products/dynamic-fee-sharing/what-is-dynamic-fee-sharing">
...
<CardGroup cols={2}>
  <Card title="Typescript SDK" icon="node-js" iconType="solid" href="/developer-guides/dynamic-fee-sharing/typescript-sdk/getting-started">
