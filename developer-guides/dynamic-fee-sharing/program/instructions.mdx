...
llmsDescription: "Explains the Dynamic Fee Sharing instruction surface from the Anchor source and IDL. Covers initialize_fee_vault, initialize_fee_vault_pda, fund_fee, fund_by_claiming_fee, claim_fee, parameters, account requirements, signers, whitelisted DAMM v2 and DBC source actions, Token 2022 transfer-fee handling, event-CPI accounts, and validation notes."
---
