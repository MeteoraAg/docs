...
This page lists the Anchor custom errors returned by the Presale Vault `presale` program.  Alpha Vault custom errors are emitted by the Anchor `VaultError` enum. 
