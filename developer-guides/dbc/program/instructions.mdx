...
| Instruction | Args | Permission | Purpose |
| --- | --- | --- | --- |
| `create_operator_account` | `permission` | Admin | Create an operator account with permission bits. |
| `close_operator_account` | None | Admin | Close an operator account. |
| `close_claim_protocol_fee_operator` | None | Admin | Close a protocol fee claim operator account. |
| `claim_protocol_fee` | `max_base_amount`, `max_quote_amount` | `ClaimProtocolFee` | Claim protocol trading fees. |
| `claim_protocol_pool_creation_fee` | None | `ClaimProtocolFee` | Claim protocol pool creation fees. |
| `zap_protocol_fee` | `max_amount` | `ZapProtocolFee` | Withdraw protocol fees through the protocol zap route. |
