...
llmsDescription: "Explains the DBC program error reference based on PoolError in MeteoraAg/dynamic-bonding-curve. Covers Anchor custom error codes 6000-6077, messages, common causes, migration errors, swap errors, fee scheduler and rate limiter errors, first-swap validation errors, zap errors, compounding errors, transfer-hook remaining account errors, pool type mismatch errors, TypeScript SDK validation helpers, and debugging steps for DBC integrations."
---
