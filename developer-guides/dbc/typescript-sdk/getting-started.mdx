...
description: "Learn how to install @meteora-ag/dynamic-bonding-curve-sdk, initialize the DBC client, read standard and transfer-hook pool state, quote swaps, and test the SDK."
llmsDescription: "Explains the first steps for building with the DBC TypeScript SDK. Covers installing @meteora-ag/dynamic-bonding-curve-sdk, initializing DynamicBondingCurveClient, using the public dynamic_bonding_curve program ID, fetching PoolConfig and VirtualPool state including transfer-hook account variants, quoting swaps with swapQuote and swapQuote2, choosing service areas, running SDK checks, local validator fixtures, and devnet faucet resources."
---
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="code-branch"
    iconType="solid"
    href="/developer-guides/dbc/typescript-sdk/transfer-hooks"
  >
