...
llmsDescription: "Explains DAMM v2 Rust CPI integration for programs that call the public Meteora cp-amm program. Covers program ID, generated bindings, CPI instruction scope, account planning for swaps, liquidity, claims, locks, rewards, and pool creation, event CPI accounts, rate-limiter instructions-sysvar remaining account behavior, Token 2022 token program handling, position NFT ownership checks, common CPI failures, best practices, generated-client guidance, public source references, and testing with localnet, devnet, and simulation workflows."
---
