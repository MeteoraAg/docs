...
| Flow | Local SDK example |
| --- | --- |
| Fixed-price presale | `examples/initialize_presale/initialize_fixed_price_presale.ts` |
| Prorata presale | `examples/initialize_presale/initialize_prorata_presale.ts` |
| FCFS presale | `examples/initialize_presale/initialize_fcfs_presale.ts` |
| Authority permissioned fixed-price presale | `examples/initialize_presale/initialize_authority_permissioned_fixed_price_presale.ts` |
| Merkle permissioned fixed-price presale | `examples/initialize_presale/initialize_merkle_tree_permissioned_fixed_price_presale.ts` |
| Permissionless deposit | `examples/deposit/permissionless_deposit.ts` |
| Permissioned Merkle deposit | `examples/deposit/permissioned_with_merkle_proof_deposit.ts` |
| Permissioned authority deposit | `examples/deposit/permissioned_with_authority_deposit.ts` |
| Claim | `examples/claim.ts` |
| Withdraw | `examples/withdraw.ts` |
| Withdraw remaining quote | `examples/withdraw_remaining_quote.ts` |
| Creator withdraw | `examples/creator_withdraw.ts` |
| Creator collect fee | `examples/creator_collect_fee.ts` |
| Unsold base token action | `examples/perform_unsold_base_token_action.ts` |
| Show presale details | `examples/show_presale_details.ts` |
| Show escrow details | `examples/show_escrow_details.ts` |
