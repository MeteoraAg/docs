...
<CardGroup cols={2}>
  ...
  <Card title="Program Events" icon="list" iconType="solid" href="/developer-guides/zap/program/events">
    Current event surface and indexing notes for Zap and downstream CPI calls.
  </Card>
