...
<CardGroup cols={1}>
  <Card title="What's Zap?" icon="question" iconType="solid" href="/helper-products/zap/what-is-zap">
...
<CardGroup cols={2}>
  <Card title="Typescript SDK" icon="node-js" iconType="solid" href="/developer-guides/zap/typescript-sdk/getting-started">
