...
llmsDescription: "Reference page for Dynamic Fee Sharing compatibility from source code: recipient count 2 to 5, non-zero shares, non-default addresses, duplicate addresses not rejected, SPL Token and Token 2022 mints with only TransferFeeConfig, MetadataPointer, and TokenMetadata extensions, Non-PDA and PDA fee vaults, manual fund_fee, PDA-only fund_by_claiming_fee, share-holder signer requirement, and whitelisted DAMM v2 and Dynamic Bonding Curve actions."
---
