...
llmsDescription: "Source-backed Alpha Vault formulas for max swappable amount, swappable amount per fill, user token claim, linear vesting, Pro Rata overflow refund, final remaining quote refund, FCFS accepted deposit, permissioned remaining quota, and Token 2022 transfer-fee accounting. Notes integer division and rounding down."
---
