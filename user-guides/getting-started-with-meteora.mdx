...
sidebarTitle: "Getting Started with Meteora"
description: "Learn the basics of using Meteora, including wallet connection, SOL requirements, transaction settings, RPC options, pool search, and pool filters."
llmsDescription: "User guide for getting started with Meteora. Explains how to connect a Solana-compatible wallet, which hot and hardware wallets are supported, why SOL is required for transaction fees and rent, how native SOL and Wrapped SOL (wSOL) differ, and when rent may be refundable or non-refundable for DAMM and DLMM actions. Covers Meteora transaction fee settings, including Priority Fee, Jito, Mixed broadcast modes, priority levels, Max Cap, and Exact Fee. Also explains how to verify activity with Solana explorers, configure RPC settings or a custom RPC, search for pools by ticker, token details, contract address, or pool address, and use pool filters for token details, pool details, and Launchpad details. Ends with guidance on finding more help through Meteora and LP Army community channels."
---
...
<div className="flex justify-center">
  <img 
    src="/user-guides/assets/wallets.png" 
    alt="wallets-png"
...
<div className="flex justify-center">
  <img 
    src="/user-guides/assets/cost-details.png" 
    alt="cost-details-png"
    className="rounded-lg w-2/3 h-auto"
  />
</div>
...
<div className="flex justify-center">
  <img 
    src="/user-guides/assets/transaction-settings.png" 
    alt="transaction-settings-png"
    className="rounded-lg w-2/3 h-auto"
  />
</div>
...
<div className="flex justify-center">
  <img 
    src="/user-guides/assets/rpc-settings.png" 
    alt="rpc-settings-png"
    className="rounded-lg w-2/3 h-auto"
  />
</div>
...
<div className="flex justify-center">
  <img 
    src="/user-guides/assets/universal-search-bar.png" 
    alt="universal-search-bar-png"
...
<div className="flex justify-center">
  <img 
    src="/user-guides/assets/pools-search.png" 
    alt="pools-search-png"
    className="rounded-lg w-full h-auto"
  />
</div>
...
<div className="flex justify-center">
  <img 
    src="/user-guides/assets/pools-filter-token.png" 
    alt="pools-filter-token-png"
...
<div className="flex justify-center">
  <img 
    src="/user-guides/assets/pools-filter-pool.png" 
    alt="pools-filter-pool-png"
    className="rounded-lg w-1/2 h-auto"
  />
</div>
...
<div className="flex justify-center">
  <img 
    src="/user-guides/assets/pools-filter-launchpad.png" 
    alt="pools-filter-launchpad-png"
    className="rounded-lg w-2/3 h-auto"
  />
</div>
...
<div className="flex justify-center">
  <img 
    src="/user-guides/assets/more-socials.png" 
    alt="more-socials-png"
    className="rounded-lg w-1/2 h-auto"
  />
</div>