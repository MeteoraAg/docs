...
<CardGroup cols={2}>
  ...
  <Card title="Memecoin Pool" icon="box" iconType="solid" href="/overview/other-products/memecoin-pool/1-what-is-memecoin-v2-pool">
    Memecoin Pools are a new type of vault that allows you to earn yield on your liquidity by staking your LP tokens.
  </Card>
  <Card title="Stake2Earn Pool" icon="star" iconType="solid" href="/overview/other-products/stake2earn-pool/1-what-is-stake2earn-v1-pool">
