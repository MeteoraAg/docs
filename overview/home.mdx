...
<CardGroup cols={2}>
  ...
  <Card title="Memecoin Pool" icon="alien" iconType="solid" href="/overview/other-products/memecoin-pool/1-what-is-memecoin-v2-pool">
    Memecoin Pools are a new type of vault that allows you to earn yield on your liquidity by staking your LP tokens.
  </Card>
  <Card title="Stake2Earn Pool" icon="snake" iconType="solid" href="/overview/other-products/stake2earn-pool/1-what-is-stake2earn-v1-pool">
    Stake2Earn Vaults are a new type of vault that allows you to earn yield on your liquidity by staking your LP tokens.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="DLMM Launch Pools" icon="circle-1" iconType="solid" href="/developer-guide/launch-pools/dlmm/1-what-is-a-dlmm-launch-pool">
  ...
  <Card title="Memecoin Pools" icon="circle-2" iconType="solid" href="/developer-guide/launch-pools/damm-v1/2-create-a-memecoin-v1-launch-pool">
    Memecoin Pool (or “Meme pools”) is a DAMM v1/v2 pool. They are meant to better support memecoin launches and liquidity.
  </Card>
  <Card title="Stake2Earn Pools" icon="circle-3" iconType="solid" href="/developer-guide/launch-pools/damm-v1/3-create-a-stake2earn-v1-launch-pool">
    Stake2Earn Pools are DAMM v1/v2 Memecoin Pools that are launched with the stake-to-earn mechanism.
  </Card>
  </CardGroup>
