...
<CardGroup>
  <Card title="Wider Token Support" icon="coin" iconType="solid">
  ...
  <Card title="Anti-Sniper LP Fee Scheduler" icon="shield" iconType="solid">
    Optional on-chain fee scheduler where swap fees start higher and drop over time (linearly or exponentially) to deter snipers.
  </Card>
