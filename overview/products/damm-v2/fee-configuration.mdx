...
Standard pools and Launch Pools use **20%** Protocol Fee and **80%** LP Fee. Swap hosts that include a referral account receive a **Referral Fee** equal to **20%** of the protocol fee.
