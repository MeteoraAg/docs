...
<Steps>
  ...
  <Step title="Seed the Pool with Rewards">
    Head to our [rewards admin dashboard](https://meteora-admin-wowcats.vercel.app/) to seed the pool with the rewards or seed the rewards via the [farming ts-sdk](/developer-guide/guides/damm-v1/farming-sdk/getting-started).
  </Step>
</Steps>