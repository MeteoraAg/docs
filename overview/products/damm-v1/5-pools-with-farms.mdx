...
- You can load rewards on your own using the farm admin dashboard that we will provide.
...
- For more info on how rewards are distributed on DLMM farms, please read [this page on DLMM Farming Rewards](https://meteora.mintlify.app/overview/products/dlmm/4-dlmm-farming-rewards).