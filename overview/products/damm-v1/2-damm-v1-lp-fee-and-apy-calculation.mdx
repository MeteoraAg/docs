---
title: "DAMM v1 LP Fee and APY Calculation"
---
...
```math
\text{base APY} = \left(\left(\frac{\text{VirtualPrice2}}{\text{VirtualPrice1}}\right)^{\frac{1 \text{ year}}{\text{Timeframe}}} - 1\right) \times 100
```

Where:
- **VirtualPrice2**: Latest Virtual Price value
- **VirtualPrice1**: Previous Virtual Price value in the last 24 Hours
