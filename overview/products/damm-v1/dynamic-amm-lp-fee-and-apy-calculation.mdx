...
```math
\text{base APY} = \left(\left(\frac{\text{Virtual Price}_2}{\text{Virtual Price}_1}\right)^{\frac{1 \text{ year}}{\text{timeframe}}} - 1\right) \times 100
```

Where:
- Virtual Price₂: Latest Virtual Price value
- Virtual Price₁: Previous Virtual Price value in the last 24 Hours
- Timeframe: Time difference between Virtual Price₁ and Virtual Price₂ (in seconds)
