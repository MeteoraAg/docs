...
Stable Pools also share similar benefits with the volatile Dynamic AMM Pools. For example, Stable Pools compose on top of Meteora’s [Dynamic Vaults](/overview/products/dynamic-vault/1-dynamic-vault-overview.mdx) lending aggregator that rebalances funds (e.g. USDC/USDT/SOL) every minute across various external lending protocols e.g. Kamino, Save (Solend), and Marginfi to optimize yield and reduce risk. 
