---
title: "What's DLMM?"
description: Meteora's Dynamic Liquidity Market Maker (DLMM) gives liquidity providers access to dynamic fees and precise liquidity concentration all in real-time.
---
