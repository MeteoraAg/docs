...
description: "Learn how to create a Meteora DLMM launch pool with configurable price bins, dynamic fees, activation controls, optional Alpha Vault, and liquidity seeding."
llmsDescription: "Guide to creating a DLMM launch pool with Meteora Invent Studio, covering setup, local validator, environment variables, keypair generation, dlmm_config.jsonc, quote mint, createBaseToken, bin step, fee bps, initial price, activation type and point, creator pool on-off control, LFG seed liquidity, single-bin seed liquidity, DLMM pool status, optional Alpha Vault, and dlmm-create-pool and seed commands."
---
...
<Steps>
  ...
  <Frame caption="This example includes creating of baseMint token before creating the DLMM launch pool.">
   <img src="/images/developer-guide/dlmm-create-pool.webp" />
  </Frame>
    ...
    <Tabs>
      <Tab title="dlmm-seed-liquidity-lfg" icon="chart-bar">
        *If you want to seed your pool with liquidity using the LFG model, you can run the following command.*
        ...
        <Frame>
        <img src="/images/developer-guide/dlmm-seed-liquidity-lfg.webp" />
        </Frame>
      </Tab>
      <Tab title="dlmm-seed-liquidity-single-bin" icon="chart-area">
        *If you want to seed your pool with liquidity in a single bin, you can run the following command.*
        ...
        <Frame>
          <img src="/images/developer-guide/dlmm-seed-liquidity-single-bin.webp" />
        </Frame>
      </Tab>
    </Tabs>
  </Step>
