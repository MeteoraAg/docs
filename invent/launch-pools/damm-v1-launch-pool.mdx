...
description: "Learn how to create a Meteora DAMM v1 launch pool with constant-product liquidity, activation controls, optional Alpha Vault, liquidity locks, and Stake2Earn settings."
llmsDescription: "Guide to creating a DAMM v1 launch pool with Meteora Invent Studio, covering setup, local validator, environment variables, keypair generation, damm_v1_config.jsonc, quote mint, createBaseToken, base and quote amounts, trade fee numerator, activation type and point, optional Alpha Vault, liquidity lock allocations, Stake2Earn farm settings, and damm-v1-create-pool commands."
---
...
<Steps>
  ...
  <Frame>
   <img src="/images/developer-guide/damm-v1-create-pool.webp" />
  </Frame>
  </Step>
</Steps>
