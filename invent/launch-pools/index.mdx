...
llmsDescription: "Overview of Meteora Invent launch pools, explaining how to choose between DBC token launch pools, DLMM launch pools, DAMM v2 launch pools, and DAMM v1 launch pools. Covers bonding curve launches with optional Token 2022 transfer hooks and DAMM migration, concentrated liquidity with LFG or single-bin seeding and limit orders, balanced and one-sided DAMM v2 pools, DAMM v1 liquidity locks and Stake2Earn workflows, shared Studio setup, config files, and dry-run validation."
---
