---
title: "Fun Launch"
sidebarTitle: "Fun Launch"
description: "Build a token launchpad scaffold powered by Meteora's Dynamic Bonding Curve program."
llmsDescription: "Guide to the Fun Launch scaffold for building a launchpad platform with Meteora's Dynamic Bonding Curve program. Covers launchpad features, DBC integration, token analytics, built-in trading interface, customizable UI components, tech stack, setup, environment configuration, installation, running the scaffold, and launchpad customization steps."
---
...
<Steps>
 <Step title="Clone and Setup Meteora Invent">
  ...
  <Step title="Start the development server">
    ...
    <Frame>
    <img src="/invent/assets/fun-launch-ui.webp" />
    </Frame>
  </Step>
   ...
   <Step title="Build the project">
    ...
    <Frame>
    <img src="/invent/assets/fun-launch-build.webp" />
    </Frame>
  </Step>
</Steps>
