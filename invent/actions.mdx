...
llmsDescription: "Guide to Meteora Invent actions, explaining how to clone and set up the meteora-invent repository, install pnpm dependencies, configure devnet or localnet environments, airdrop SOL, start the local validator, and run supported onchain action commands for Meteora programs such as DLMM, DAMM v2, DAMM v1, DBC, Alpha Vault, and related launch workflows."
---
