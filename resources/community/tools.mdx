...
<CardGroup cols={1}>
  ...
  <Card title="Ultra LP" img="/images/resources/community/tools/ultralp-banner.jpeg" href="https://www.ultralp.com/">
   ...
   <Card title="Starseed" img="/images/resources/community/tools/starseed-banner.jpg" href="https://www.starseed.dev/">
    Starseed is an advanced, customizable Solana trading platform built to solve the inefficiency of traders juggling 10+ websites. It unifies essential tools onto a single dashboard where users can manage Meteora DLMM positions, swap tokens, and utilize advanced tools for automated position management. The platform's mission is to be Solana's one-stop-shop, offering a best-in-class experience where traders spend more time winning and less time juggling tabs.
  </Card>
</CardGroup>