...
sidebarTitle: "Cookies Notice"
description: "Read Meteora's Cookies Notice and Policy for website cookies, similar technologies, choices, and contact information."
llmsDescription: "Meteora Cookies Notice and Policy, last updated 10 October 2025. Explains what cookies are, why Meteora uses cookies, types of cookies used on the website, cookie providers such as Google Analytics, Amplitude, and Cloudflare, how cookies support website functionality and analytics, how users can manage cookies, contact information, and the relationship between the Cookie Policy, Terms of Service, and Privacy Policy."
---
...
6. We may place cookies on your computer or device and receive information stored in cookies when you use or visit:<br />

   **(a)** the Website; <br/>
   **(b)** any Content that are made available on or through the Website; or <br/>
   **(c)** any websites, services and applications provided by third parties that are made available on or through the Website (such as Third-Party Service and Third-Party Content). <br/>
