...
description: "Read Meteora's Privacy Policy for personal data collection, use, disclosure, rights, cookies, and contact information."
llmsDescription: "Meteora Privacy Policy, last updated 28 April 2026. Covers personal data collected through the Meteora website, wallet information, communications, social media information, internet activity information, cookies and similar technologies, use and disclosure of personal data, user rights and choices, consent withdrawal, data retention, security, international transfers, minors, third-party links, and contact information."
---

**Last updated: 28 April 2026**

Welcome to Meteora’s website (accessible at https://www.meteora.ag/) (the "**Website**"), provided and operated by Meteora Nova Limited (the "**Company**", "**we**", "**our**" or "**us**").
...
- You should refer to our [Cookies Notice and Policy](/legal/cookies-notice-and-policy) for more information relating to the various cookies and related technologies that are used on our Platform.
