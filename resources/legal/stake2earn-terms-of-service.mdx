---
title: "Stake2Earn Terms of Service"
sidebarTitle: "Stake2Earn Terms"
description: "Read the Stake2Earn Terms of Service for app access, smart contracts, user obligations, risks, fees, disclaimers, and legal terms."
llmsDescription: "Stake2Earn Terms of Service for M3M3 and related smart contracts. Covers eligibility, restricted territories, app availability, no offer or solicitation, jurisdictional compliance, services, fees, intellectual property, user terms, risks borne by users, external sites, disclaimers, limitation of liability, indemnity, privacy policy, electronic disclosures and signatures, governing law, dispute resolution, notices, entire agreement, force majeure, and assignment."
---
...
M3M3 may be visualised on a user interface that the user can interact with, including but not limited to the website at https://app.meteora.ag/pools#stake2earnpools and each of their subdomains, or our mobile or web applications (the "Site"). The Smart Contracts and the Site are collectively referred to in these Terms as (the "App"). Using the App, users can interact with the underlying Smart Contracts to create Vaults, view their Vaults created or accessed, and interact with other users in M3M3 ecosystem.
...
13.4.  You may withdraw your consent to receive agreements or disclosures electronically by contacting us at meteora_support@meteora.ag. However, once you have withdrawn your consent you will not be able to access the Services or the Site.
...
To give us notice under these Terms, the user must contact the Company by email at **meteora_support@meteora.ag**
