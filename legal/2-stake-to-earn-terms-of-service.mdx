---
title: "Stake-to-Earn Terms of Service"
---
...
M3M3 may be visualised on a user interface that the user can interact with, including but not limited to the website at https://m3m3.meteora.ag/ and each of their subdomains, or our mobile or web applications (the "Site"). The Smart Contracts and the Site are collectively referred to in these Terms as (the "App"). Using the App, users can interact with the underlying Smart Contracts to create Vaults, view their Vaults created or accessed, and interact with other users in M3M3 ecosystem.
