...
Partners (e.g. launchpads) that integrate DBC to create and launch tokens on their platform, can also configure a fee time scheduler as part of the virtual bonding curve.
